...
if ($paidstatus=="true"){
  ...
  $signing = '';
    ...
    if ($signed === $data['x_signature']) {
        ...
        $sqlcart ="SELECT * FROM GARDENORDER WHERE EMAIL = '$email'";
        ...
        $sqldeletecart = "DELETE FROM GARDENORDER WHERE EMAIL = '$email'";
     ...
     <p><center>Press back button to return to Gardeneous</center></p></div></body>';
}
else{
     echo 'Payment Failed!';
}
