...
import 'package:gardeneous/billscreen.dart';
...
class _CartScreenState extends State<CartScreen> {
          ...
          Container(
              ...
              child: Card(
                child: SingleChildScrollView(
                  ...
                  Text(
                    numcart.toString() + " item/s in your cart.",
                    style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        color: Colors.black),
                                    ...
                                    child: Row(
                                      ...
                                      Container(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl:
                                                "https://sopmy520.com/Gardeneous/images/gardenimages/${cartList[index]['image']}.jpg",
                                            fit: BoxFit.fill,
                                            imageBuilder:
  ...
  void _loadCart() {
    http.post("https://sopmy520.com/Gardeneous/php/load_cart.php", body: {
  ...
  void _deleteCart(int index) {
    http.post("https://sopmy520.com/Gardeneous/php/delete_cart.php", body: {
      "email": widget.user.email,
  ...
  _calculatePayment() {
    setState(() {
      if (_delivery == "Pickup") {
        ...
        delcharge = payable * 0.06;
        payable = totalPrice + delcharge;
      }
    });
  }

  _loadGardenDetail(int index) async {
    ...
    await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (BuildContext context) => GardenDetails(
                  garden: garden,
                  user: widget.user,
                )));
    _loadCart();
